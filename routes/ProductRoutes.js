  ...
  async (req, res) => {
    ...
    try {
      ...
      if (typeof updates.price !== 'undefined')
        updates.price = coerceNumber(updates.price, updates.price);
      if (typeof updates.salePrice !== 'undefined')
        updates.salePrice = coerceNumber(updates.salePrice, undefined);
      if (typeof updates.stock !== 'undefined')
        updates.stock = parseInt(updates.stock, 10) || updates.stock;
      if (typeof updates.featured !== 'undefined')
        updates.featured = coerceBoolean(updates.featured);
