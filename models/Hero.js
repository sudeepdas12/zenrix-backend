...
const heroSchema = new mongoose.Schema({
  ...
  backgroundImage: {
    type: String,
    default: 'https://images.unsplash.com/photo-1557821552-17105176677c?w=1200',
  },
  ...
  spotlightCopy: {
    type: String,
    default: 'Desk-ready audio, wearable, and carry picks — matched to look and perform together.',
  },
